      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm">
            ...
            <Link to="/mapa" className="w-full py-4 bg-emerald-500 hover:bg-emerald-400 text-emerald-950 font-bold rounded-xl transition-all shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2">
