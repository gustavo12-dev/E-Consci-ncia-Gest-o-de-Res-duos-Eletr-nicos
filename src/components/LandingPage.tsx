      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-emerald-950">
        ...
        >
          <span className="inline-block px-4 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-sm font-mono mb-6 backdrop-blur-sm">
            COLETA GRATUITA • CERTIFICADO DE DESCARTE
          </span>
          ...
          <p className="text-xl text-emerald-100/80 mb-10 max-w-2xl mx-auto leading-relaxed">
            Gestão profissional de resíduos eletrônicos. Coletamos, reciclamos e certificamos o seu descarte com responsabilidade ambiental.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/agendar" className="px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-emerald-950 font-semibold rounded-full transition-all shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2">
              <Phone className="w-5 h-5" /> Agendar Coleta Imediata
            </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-stone-300 leading-relaxed">
                <p>
                  Atuamos no comércio e gerenciamento de resíduos eletroeletrônicos, de informática, sobras industriais, automação e sucatas diversas. Com sede em São Paulo capital, a empresa surgiu de uma ideia de reaproveitar o lixo eletrônico gerado e acumulado por empresas.
                </p>
                <p>
              ...
              <Link to="/sobre" className="mt-10 px-8 py-4 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-lg inline-flex items-center gap-2 transition-all shadow-lg shadow-emerald-600/20">
      ...
      <section className="py-24 bg-white border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="text-5xl font-light text-emerald-900 mb-2 serif">50M+</div>
              <div className="text-stone-500 uppercase tracking-widest text-xs font-semibold">Toneladas de E-lixo/ano</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-light text-emerald-900 mb-2 serif">70%</div>
              <div className="text-stone-500 uppercase tracking-widest text-xs font-semibold">Exportado Irregularmente</div>
            </div>
            <div className="text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="space-y-12">
                {[
                  ...
                  { step: "02", title: "Coleta e Transporte", desc: "Nossa equipe especializada retira os resíduos no local combinado." },
                  { step: "03", title: "Triagem e Reciclagem", desc: "Os materiais são separados e destinados para reciclagem ou reuso." },
                  { step: "04", title: "Certificação", desc: "Emitimos o Certificado de Descarte Ecológico e o Selo de Sustentabilidade." },
                ].map((item, i) => (
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -left-10 bg-emerald-500 p-8 rounded-3xl text-emerald-950 shadow-xl">
                ...
                <div className="text-sm opacity-80">Certificado pelo IBAMA</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { 
                ...
                desc: "Parcerias com cooperativas para garantir o destino final adequado." 
              },
              { 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-emerald-100/70 mb-12 text-lg leading-relaxed">
                Acompanhe em tempo real o quanto de metais pesados deixamos de descartar no solo este mês através da nossa rede escolar.
              </p>
      ...
      <footer className="bg-[#0a3150] text-white pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            {/* Facebook Widget Simulation */}
            <div className="mt-12">
              <h3 className="text-emerald-400 text-2xl font-bold mb-6">Facebook</h3>
              <div className="bg-[#1c1e21] rounded overflow-hidden border border-white/10">
                <div className="p-4 flex gap-3 items-start">
                  <div className="w-12 h-12 bg-white rounded flex items-center justify-center overflow-hidden">
                    <Recycle className="w-8 h-8 text-emerald-600" />
                  </div>
                  <div>
                    <div className="font-bold text-white leading-tight">E-Consciência</div>
                    <div className="text-[10px] text-stone-400">3.472 seguidores</div>
                  </div>
                </div>
                <div className="bg-[#242526] p-2 flex justify-between border-t border-white/5">
                  <button className="flex items-center gap-1 text-xs bg-[#3a3b3c] hover:bg-[#4e4f50] px-2 py-1 rounded transition-colors">
                    <Facebook className="w-3 h-3 fill-current" /> Seguir Página
                  </button>
                  <button className="flex items-center gap-1 text-xs bg-[#3a3b3c] hover:bg-[#4e4f50] px-2 py-1 rounded transition-colors">
                    Compartilhar
                  </button>
