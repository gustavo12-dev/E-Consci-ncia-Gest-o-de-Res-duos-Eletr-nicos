      ...
      <main className="max-w-7xl mx-auto px-4 py-20">
        ...
        <section className="max-w-4xl mx-auto mb-32">
          ...
          <div className="space-y-20 relative before:absolute before:left-[19px] before:top-0 before:bottom-0 before:w-px before:bg-stone-200">
            {[
              { year: "2026", title: "O Início", desc: "O projeto surge como uma iniciativa acadêmica focada na problemática do lixo eletrônico na Primeira Igreja Batista de Amparo/SP." },
