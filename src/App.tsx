...
import EducacaoAmbiental from './components/EducacaoAmbiental';
import MapaPontosColeta from './components/MapaPontosColeta';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/mapa" element={<MapaPontosColeta />} />
        <Route path="/pontos-coleta" element={<MapaPontosColeta />} />
